...
"""
from fadc_octavia_provider.fortiadc_agent.fadc_api.healthcheck import HealthCheck
...
class HealthMonitor(object):
    ...
    def delete_direct(self, hm):
        LOG.debug("directly delete healthmonitor")
        self.hc.delete_direct(hm)
    ...
    def check_parameter(self, hm):
        ...
        if hm.type in ["HTTP", "HTTPS"]:
            ...
            hm.fadc_method_type = "http_get"
        hm.fadc_port = self.o_device.fadc_healthcheck_port
